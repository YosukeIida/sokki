...
---
PR #114 作成: https://github.com/YosukeIida/sokki/pull/114 — 伝播テスト（pipeline.start→engine）2件、WhisperKitEngine の decodeOptions seam テスト 3件を追加。RecordingView Snapshot に .modelContainer を注入。全354テスト中の失敗は既知 Snapshot 4件のみ。レビュー待ち（マージ後に Done + Issue #97 クローズ）。
---
<!-- COMMENTS:END -->
